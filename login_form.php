								...
								<form onsubmit="return false" id="login" class="login100-form ">
                                    ...
                                    <div class="form-group">
                                       <label for="email">Email</label>
                                        <input class="input" type="email" name="email" placeholder="Email" id="mail" required style="border-radius:5px">
                                    </div>
                                    
                                    <div class="form-group">
                                       <label for="password">Password</label>
                                        <input class="input" type="password" name="password" placeholder="Password" id="password" required style="border-radius:5px">
                                    </div>
